					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Transaction Report</h2>
							</header>
							<div class="panel-body">
								
								<form class="form-horizontal form-bordered" action="transacreport" method="post" autocomplete="off">
									...
									String strDate2=request.getParameter("end"); 					
									...
									if(strDate1!=null && strDate2!=null&& !strDate1.isEmpty() && !strDate2.isEmpty()){
										...
										String testdate1=to.format(from.parse(strDate1));
										String testdate2=to.format(from.parse(strDate2));
										String date1=testdate1.substring(0,4)+"."+testdate1.substring(5,7)+"."+testdate1.substring(8);
										String date2=testdate2.substring(0,4)+"."+testdate2.substring(5,7)+"."+testdate2.substring(8);
										
										
												
									/* 	dbdate=date.substring(8)+"/"+date.substring(5,7)+"/"+date.substring(0,4); */
										
										String qry="select * from ministatement where date between '"+date1+"' and '"+date2+"' ";
									 rs = st.executeQuery(qry);
										...
										rs = st.executeQuery(qry);
										/* dbdate=date1.substring(8)+"/"+date1.substring(5,7)+"/"+date1.substring(0,4); */
										
									}
									
									while(rs.next()){
										String date=rs.getString("date");
										String dbdate=date.substring(8)+"/"+date.substring(5,7)+"/"+date.substring(0,4);
									%>
										<tr >
...
jQuery("#start").on('input',function() {
...
jQuery(document).ready(function($) {
    ...
    if (window.history && window.history.pushState) {
      ...
      window.history.pushState('forward', null, './transacreport.jsp');
    }
