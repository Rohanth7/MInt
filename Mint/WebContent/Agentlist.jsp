			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<section class="panel">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									String qry = "select sno,name,lastname,imei,email,phn,aadhar,address,city,state,status from register ";
									rs = st.executeQuery(qry);
									while(rs.next()){
										String value=rs.getString("status");
										String aa=rs.getString("aadhar");
										String aad="********"+aa.substring(8);
									%>
										<tr class="gradeA">
											...
											<td class="actions">
											<a href="editagent.jsp?u=<%=rs.getString("sno") %>"><button type="button" class="mb-xs mt-xs mr-xs btn btn-primary">Edit</button></a>
										...
										<a  href="delete.jsp?u=<%=rs.getString("sno") %>&v=1"><button id="activate1" style="display:none;"   class="mt-sm mb-sm btn-xs btn-primary">test</button></a>
										<% 	}%>
											...
											<a  href="delete.jsp?u=<%=rs.getString("sno") %>&v=2"><button id="deactivate1" style="display:none;"   class="mt-sm mb-sm btn-xs btn-primary">test</button></a>
											<% 	}%>
											</td>
											...
											<div class="panel-body">
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>Are you sure that you want to Activate this Agent?</p>
													</div>
												</div>
											</div>
										...
										<section class="panel">
											...
											<div class="panel-body">
												<div class="modal-wrapper">
													...
													<div class="modal-text">
														<p>Are you sure that you want to De-Activate this Agent?</p>
													</div>
												</div>
											</div>
											<footer class="panel-footer">
						...
						<button style="display:none;"  id="sticky-activate" class="mt-sm mb-sm btn btn-success">Activated</button>	
						<button style="display:none;"  id="sticky-deactivate" class="mt-sm mb-sm btn btn-success">DeActivated</button>	
...
jQuery(document).ready(function($) {
    ...
    if (window.history && window.history.pushState) {
      ...
      window.history.pushState('forward', null, './Agentlist.jsp');
    }
