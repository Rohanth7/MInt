...
Enter Beneficiary Aadhar number:<input type="text" name="benefitaad" value="" required><br>
Enter Beneficiary Acc number:<input type="text" name="benefitacc" value="" required><br>
